...
#BSP: modify for KF6h (KFLHLEYJ-1) by fengshan.wang 20201109 start
BOOT_LOGO = hdplus1600
#BSP: modify for KF6h (KFLHLEYJ-1) by fengshan.wang 20201109 end
BUILD_AGO_GMS = yes
BUILD_KERNEL = yes
BUILD_LK = yes
BUILD_MD32 = no
BUILD_PRELOADER = yes
#BSP: add project macro by wang.qin 20210118 start
CUSTOM_BUILD_VERNO = CY-KF6-H6219-D
#BSP: add project macro by wang.qin 20210118 end
...
#TSD:modify KFLHLEYJ-13 by ang.gu 20210113 start
CUSTOM_MODEM=kf6h_h6219_d1_go_kf6
#TSD:modify KFLHLEYJ-13 by ang.gu 20210113 end
...
#BSP:modify audio bring up KFLHLEYJ-942 xinyu.zhao 20201209 start
...
MTK_BUILD_VERNO=KF6-H6219DI-RGo-GL-MP-220110V343
TRAN_FINGERPRINT_BUILD_VERNO=220110V343
#SDD: add project sw version by jiangping.guo 20201102 end
#BSP: add project macro by wanghanfeng 20201102 start
CUSTOM_TRAN_PROJECT=tran_kf6h
CUSTOM_TRAN_BOM=tran_kf6h_e1
